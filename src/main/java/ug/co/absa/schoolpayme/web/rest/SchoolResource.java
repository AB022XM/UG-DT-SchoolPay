...
import ug.co.absa.schoolpayme.repository.SchoolRepository;
import ug.co.absa.schoolpayme.service.SchoolService;
...
/**
 * REST controller for managing {@link ug.co.absa.schoolpayme.domain.School}.
 */
@RestController
@RequestMapping("/api")
