...
import ug.co.absa.schoolpayme.repository.AddressRepository;
import ug.co.absa.schoolpayme.service.AddressService;
...
/**
 * REST controller for managing {@link ug.co.absa.schoolpayme.domain.Address}.
 */
@RestController
@RequestMapping("/api")
